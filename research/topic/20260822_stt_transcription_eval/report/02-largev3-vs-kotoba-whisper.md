...
| 모델 | CER↓ | chrF++↑ | BLEU(char)↑ | ROUGE-L F1↑ | STT 총 소요 | RTF↓ | 아웃트로 환각 |
|---|---|---|---|---|---|---|---|
| **large-v3** | **0.289** | **51.14** | **68.69** | **0.766** | 527.3s | 0.753 | 5/150 |
| kotoba-whisper-v2.0-faster | 0.318 | 48.17 | 63.04 | 0.734 | 70.5s | 0.080 | **0/150** |
| large-v3-turbo | 0.292 | 51.09 | 68.29 | 0.764 | **46.3s** | **0.068** | 6/150 |
...
large-v3의 5건과 통계적으로 유의미한 차이는 아님).

### 카테고리별 CER

| 카테고리 | large-v3 | kotoba | large-v3-turbo |
|---|---|---|---|
| 게임 | 0.584 | 0.625 | 0.588 |
| 여행 | 0.473 | 0.528 | 0.462 |
| 음식,요리 | 0.272 | 0.286 | 0.285 |
| 일상,소통 | 0.152 | 0.186 | 0.159 |
| 패션,뷰티 | 0.114 | 0.116 | 0.120 |
...
| 모델 | 일치 | 부분일치 | 불일치 |
|---|---|---|---|
| large-v3 | 75 (50%) | 58 (39%) | 17 (11%) |
| kotoba-whisper | 64 (43%) | 65 (43%) | 21 (14%) |
| large-v3-turbo | 70 (47%) | 65 (43%) | 15 (10%) |
