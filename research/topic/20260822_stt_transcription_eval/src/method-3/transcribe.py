...
large-v3-turbo (faster-whisper alias for
mobiuslabsgmbh/faster-whisper-large-v3-turbo) — user request 2026-08-22,
third model in the comparison alongside large-v3 (method-1) and
kotoba-whisper-v2.0-faster (method-2) on the same 150-pair dataset.
...
identical to method-1/method-2 so the comparison isolates the model swap.
"""
...
OUT_PATH = Path(__file__).resolve().parents[2] / "out" / "method-3" / "transcripts.jsonl"
