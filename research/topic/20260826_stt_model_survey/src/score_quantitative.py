...
as 20260822_stt_transcription_eval (CER/chrF++/BLEU-char/ROUGE-L), per-category
and overall. Shared across all methods in this topic (unlike 20260822 which
duplicated this file per method) — takes --method to pick the out/ subdir.
