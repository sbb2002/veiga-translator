...
model (llama-server/gemma, expected at :8080, pure text-comparison tool — no
backend/ import) whether the hypothesis preserves the reference's meaning.
Same 3-way verdict scheme as 20260822_stt_transcription_eval /
20260826_stt_model_survey. Shared across methods here via --method (out/
<method>/ subdir).
